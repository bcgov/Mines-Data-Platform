...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --dev-wh)            DEV_WAREHOUSE_ID="$2";    shift 2 ;;
        --test-wh)           TEST_WAREHOUSE_ID="$2";   shift 2 ;;
        --prod-wh)           PROD_WAREHOUSE_ID="$2";   shift 2 ;;
...
apply_config() {
    ...
    set_gh_variable "DEV_WAREHOUSE_ID"   "$DEV_WAREHOUSE_ID"
    set_gh_variable "TEST_WAREHOUSE_ID"  "$TEST_WAREHOUSE_ID"
    set_gh_variable "PROD_WAREHOUSE_ID"  "$PROD_WAREHOUSE_ID"
